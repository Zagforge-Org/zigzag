//! Windows loopback TCP probe via raw Winsock.
//!
//! std.Io.net.connect maps a refused connection to error.Unexpected and, in
//! debug/test builds, dumps a noisy NTSTATUS stack trace before returning. A direct
//! Winsock connect() reports refusal quietly, which is what a port probe wants.
...
pub fn canConnectLoopback(_: std.Io, port: u16) bool {
